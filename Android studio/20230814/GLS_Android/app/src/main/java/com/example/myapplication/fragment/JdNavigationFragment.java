...
public class JdNavigationFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        /*******多车spinner选择模块**********/
        mapCar = new HashMap<String, ROSBridgeClient>() { // 使用了HashMap顺序是不可控的
            {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view1, int position, long id) {  // 默认初始化会调用一次 // 此处的view1是有问题的，要使用全局的view才能正常显示，做区别写成了view1
        ...
        Runnable task = new Runnable() {
            ...
            public void run() {
                ...
                com.example.myapplication.Topic<ActionStateNumber> actionStateTopicCar = new com.example.myapplication.Topic<ActionStateNumber>("/action_state_number_jd", ActionStateNumber.class, clientCar);
